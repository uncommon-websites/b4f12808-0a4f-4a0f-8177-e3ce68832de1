  ...
  <div class="container-custom flex items-center justify-between">
    <div class="flex items-center gap-8">
      ...
      <div class="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600">
        <a href="#features" class="hover:text-gray-900 transition-colors">Platform</a>
        ...
        <a href="mailto:prashanth@sagepilot.ai" class="hover:text-gray-900 transition-colors">Contact</a>
      </div>
    </div>

    <div class="flex items-center gap-3">
      <a href="mailto:prashanth@sagepilot.ai" class="px-3 py-1.5 text-xs font-semibold bg-black text-white rounded hover:bg-gray-800 transition-colors uppercase tracking-wide">
        Book a Demo
      </a>
    </div>
  </div>
